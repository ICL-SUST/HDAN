...
data_path = '../../../dataset/iSeg2019/iSeg-2019-Validation/'
target_path = '../../../dataset/iSeg2019_hdf5/iSeg-2019-Validation/'
...
def build_h5_validation_set(data_path, target_path):
...
if __name__ == '__main__':
    ...
    build_h5_validation_set(data_path, target_path)
    print("welll done")
